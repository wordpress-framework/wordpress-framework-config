...
class Config_Test extends TestCase {
    ...
    public function test_modification() {
        ...
        $config->set( 'one', 'one_data_modificated_two' );
        $this->assertEquals( 'one_data_modificated_two', $config->one );

        $config->two->two_one = 'two_one_data_modificated';
        $this->assertEquals( 'two_one_data_modificated', $config->two->two_one );

        $config->two->set( 'two_one', 'two_one_data_modificated_two' );
        $this->assertEquals( 'two_one_data_modificated_two', $config->two->two_one );
        ...
        $config->two->set( 'two_two', [ 'two_two_one' => 'two_two_one_data_modificated_two' ] );
        $this->assertEquals( 'two_two_one_data_modificated_two', $config->two->two_two->two_two_one );

        $config->nonexistent = 'nonexistent_data';
        $this->assertEquals( 'nonexistent_data', $config->nonexistent );

        $config->set( 'nonexistent_two', 'nonexistent_data' );
        $this->assertEquals( 'nonexistent_data', $config->nonexistent_two );
    }
